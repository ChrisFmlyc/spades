...
The human owns project intent and verification. Help them express the
intent that downstream Scope and Plan checks will use.
...
silence is not. Ask about any content they have yet to confirm.
...
<!-- What this project deliberately will NOT
...
the human's own point. Probe the non-goals: they define where a Scope would
drift from project intent. Match the ceremony to the work: a
...
5. **Non-goals** — explicit, checkable statements. Good:
   *"Argus does not take automated remediation
