...
- **patch**: Objective always asks for a strategy reference after slug confirmation, accepts a URL or ID, and verifies the unchanged reference in the Linear outcome label description.
